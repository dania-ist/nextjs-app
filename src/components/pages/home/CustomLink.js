...
const CustomLink = (props) => {
  return (
    <div
    className={`d-flex justify-content-between align-items-center link-primary-two ${props.class}`}
  >
    ...
    <Link target={props.target?props.target:'_self'} href={props.link} className="link-primary-two__image"><svg
